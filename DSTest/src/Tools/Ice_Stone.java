 ...
 * @author 14520
 */
public class Ice_Stone implements Base_Tools{
    protected String URL_Image_Frame = "res/window_2.PNG";     
    protected BufferedImage Image_Frame;

    protected String URL_Image_NOT = "res/Tools/Ice_Stone_not.PNG";  
    protected String URL_Image = "res/Tools/Ice_Stone.PNG";     
    protected String URL_Image_PICKED = "res/Tools/Ice_Stone_picked.PNG";  
    ...
    public void DrawSuggest(Graphics g, int X, int Y) {
        ...
        Item_Ice  ice  = new Item_Ice (X +  65 ,Y + 85);
        ...
        g.setFont(font);                      
        g.drawString("Cold", X + 100, Y + 250);
        
        g.setFont(font2);   
        g.drawString("ICE STONE", X + 130, Y + 90);
        g.drawString("x 15", X + 127, Y + 170);
