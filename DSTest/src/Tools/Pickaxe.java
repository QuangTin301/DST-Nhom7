 ...
 * @author 14520
 */
public class Pickaxe implements Base_Tools{
    protected String URL_Image_Frame = "res/window_2.PNG";     
    protected BufferedImage Image_Frame;

    protected String URL_Image_NOT = "res/Tools/Pickaxe_not.PNG";  
    protected String URL_Image = "res/Tools/Pickaxe.PNG";     
    protected String URL_Image_PICKED = "res/Tools/Pickaxe_picked.PNG";  
    ...
    public void DrawSuggest(Graphics g, int X, int Y) {
        ...
        g.setFont(font);                      
        g.drawString("CONG CU", X + 100, Y + 250);
        
        g.setFont(font2);   
        g.drawString("PICK AXE", X + 135, Y + 90);
        g.drawString("x 2", X + 133, Y + 170);
        g.drawString("x 2", X + 213, Y + 170);
    }
}
