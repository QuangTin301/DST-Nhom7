 ...
 * @author 14520
 */
public class Hp_Potion implements Base_Tools{
    protected String URL_Image_Frame = "res/window_2.PNG";     
    protected BufferedImage Image_Frame;

    protected String URL_Image_NOT = "res/Tools/Hp_Potion_not.PNG";  
    protected String URL_Image = "res/Tools/Hp_Potion.PNG";     
    protected String URL_Image_PICKED = "res/Tools/Hp_Potion_picked.PNG";  
    ...
    public void DrawSuggest(Graphics g, int X, int Y) {
        ...
        Flower  flower = new Flower (X +  65 ,Y + 85);
        Silk    silk   = new Silk   (X + 140 ,Y + 85);
        ...
        g.setFont(font);                      
        g.drawString("Heal", X + 100, Y + 250);
        
        g.setFont(font2);   
        g.drawString("HP POTION", X + 130, Y + 90);
        g.drawString("x 5", X + 133, Y + 170);
